...
df = pd.DataFrame({
    'day': t,
    'x with initial point (0.5,0.99)': sol[:,0],
    'n with initial point (0.5,0.99)': sol[:,1],
    'x with initial point (0.5,0.2)': sol1[:,0],
    'n with initial point (0.5,0.2)': sol1[:,1]
})
...
df.plot(x='day',
        y=['x with initial point (0.5,0.99)', 'n with initial point (0.5,0.99)', 'x with initial point (0.5,0.2)', 'n with initial point (0.5,0.2)'],
...
plt.legend(fontsize=14.5, loc='upper left')
# plt.tight_layout()
# print(x)
